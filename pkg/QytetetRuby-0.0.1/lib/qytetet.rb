...
module ModeloQytetet
  class Qytetet
    ...
    def inicializar_cartas_sorpresa
      ...
      @mazo << Sorpresa.new("La pobre de tu viejita te paga la fianza y sales de la cárcel. Deja ya de darle disgustos, porfa." , 0, TipoSorpresa::SALIRCARCEL)
      @mazo << Sorpresa.new("Tu colega dice que te acerca a casa en coche. No puedes negarte por perro. Vuelves a la casilla 7.", 7, TipoSorpresa::IRACASILLA)
      @mazo << Sorpresa.new("Tienes que sacar apuntes de PDOO cagando leches que cierra la fotocopiadora. Vuelves a la casilla 19.", 19, TipoSorpresa::IRACASILLA)
      @mazo << Sorpresa.new("Abres una caja en Steam del counter y te toca un cuchillito. Ganas 500€", 450, TipoSorpresa::PAGARCOBRAR)
      @mazo << Sorpresa.new("Te han pillado robando el Ethernet de la ETSIIT. Vas a la cárcel.", @tablero.carcel.numeroCasilla, TipoSorpresa::IRACASILLA)
      @mazo << Sorpresa.new("Suspendes PDOO otra vez. 300 euritos la tercera matrícula.", -300, TipoSorpresa::PAGARCOBRAR)
      @mazo << Sorpresa.new("Tus amigos te invitan a cenar por tu cumple. Te dan 100€", -100, TipoSorpresa::PORJUGADOR)
      @mazo << Sorpresa.new("Ganas 100€ por jugador porque haces trampas. Te debería dar vergüenza. TRAMPOSO.", -100, TipoSorpresa::PORJUGADOR)
      @mazo << Sorpresa.new("Tienes que hacer reformas pa instalar la fibra óptica. Pagas 100€ por casa y 150€ por hotel." , -20, TipoSorpresa::PORCASAHOTEL)
      @mazo << Sorpresa.new("Pagas 200€ por casa/hotel porque te ha pillao hacienda evadiendo impuestos. Eres peor que la iglesia.", 15, TipoSorpresa::PORCASAHOTEL)
    end
